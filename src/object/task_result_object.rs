...
impl DrawableTaskResult {
	...
	let mut done_work_text = EffectableWrap::new(
	    MovableWrap::new(
		Box::new(VerticalText::new(format!("お客人数 {}人", number_to_jk(task_result.done_works as u64)),
	...
	let mut money_text = EffectableWrap::new(
	    MovableWrap::new(
		Box::new(VerticalText::new(format!("収入 {}円", number_to_jk(task_result.total_money as u64)),
