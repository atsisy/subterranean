...
impl EndSceneFlow {
    pub fn new<'a>(ctx: &mut SuzuContext<'a>, t: Clock) -> Self {
	    ...
	    format!("評判　　　{}\n\n総収入　　{}円\n\n接客回数　{}回\n\n貸出回数　{}回\n\n返却回数　{}回\n\n配架冊数　{}冊\n\n誤評価数　{}回",
		    ctx.savable_data.suzunaan_status.reputation as u32,
		    number_to_jk::number_to_jk(ctx.savable_data.task_result.total_money as u64),
		    number_to_jk::number_to_jk(ctx.savable_data.award_data.customer_count as u64),
		    number_to_jk::number_to_jk(ctx.savable_data.award_data.borrowing_count as u64),
		    number_to_jk::number_to_jk(ctx.savable_data.award_data.returning_count as u64),
		    number_to_jk::number_to_jk(ctx.savable_data.award_data.shelving_count as u64),
		    number_to_jk::number_to_jk(ctx.savable_data.award_data.returning_check_mistake_count as u64),
	    ),
